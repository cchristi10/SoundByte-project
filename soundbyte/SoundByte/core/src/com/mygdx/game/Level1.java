...
public class Level1 extends BaseScreen{
    ...
    public void initialize() {
        ...
        kickLabel.setPosition(430 * WidthOffset,96* HeightOffset);
        ...
        snareLabel.setPosition(780 * WidthOffset,96 * HeightOffset);
