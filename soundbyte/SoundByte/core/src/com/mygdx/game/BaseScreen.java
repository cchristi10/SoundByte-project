...
public abstract class BaseScreen implements Screen, InputProcessor
{
    ...
    protected static final int virHeight = Gdx.graphics.getHeight();
    protected static final int virWidth = Gdx.graphics.getWidth();
    protected static float WidthOffset = virWidth / 1920f;
    protected static float HeightOffset = virHeight / 1080f;
